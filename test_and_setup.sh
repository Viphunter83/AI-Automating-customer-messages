...
# Скрипт для тестирования Railway API и настройки фронтенда
# Использование: ./test_and_setup.sh YOUR_RAILWAY_URL

RAILWAY_URL="${1:-}"

if [ -z "$RAILWAY_URL" ]; then
    echo "❌ Ошибка: Укажите Railway URL"
    echo "Использование: ./test_and_setup.sh https://your-app.railway.app"
    echo ""
...
echo ""
echo "📋 Следующие шаги:"
echo "1. Проверьте .env.production.local в frontend/"
echo "2. Задеплойте фронтенд на Vercel:"
